...
typedef struct _img_info
{
	...
	uint32		background_color;		/* The wanted background's color							*/		
	int16		thumbnail;				/* 1 if true else 0.
										   Some formats have a thumbnail embedded in the picture, 
										   if 1, we want only this thumbnail.						*/
	...
	/* The following variable are only for Information Prupose, the zview doesn't 
	   use it for the decoding routine but only for the information dialog							*/ 
